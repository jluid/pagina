...
<body  >
       ...
       <!--DIV DESTACADOS-->
        <div class="div_destacados">
            ...
            <div class="producto_3">
                <img src="./imagenes/adidas_6.jpg" alt="">
        ...
        <div class="div_msagregarp_close" id="div_msagregarp_close">
         ...
         <div class="Alerta_registro" id="Alerta_registro" >
          <div class="div_error">
              <span class="material-icons" id="icn_cerraralerta" > 
               check_circle  
              </span>
          </div>
          <div>
    ...
    <script src="./cargarpagina.js"></script>
</body>
</html>
<?php } ?> 
