<?php
  ...
  $query = "SELECT marca_producto, descripcion_producto, precio,genero,imagen FROM `productos` WHERE genero='M'";
       ...
       <!--DIV DESTACADOS-->
        ...
        <?php foreach ($result as $row) { ?>
                ...
                <div class="producto_1">
                    ...
                    <label class="lbl_marca"> <?php echo $row['marca_producto']; ?></label>
