<?php
  ...
  $query = "SELECT id_producto, marca_producto, descripcion_producto, precio,genero,imagen FROM `productos` WHERE marca_producto='adidas'";
        ...
        <div class="div_destacados">
            <?php foreach ($result as $row) { ?>
                ...
                <div class="mis_productos">
                    ...
                    <button id="btn_agregarc" class="btn_agregarc" data-argumento="hola" >agregar al carrito</button>
                </div>
